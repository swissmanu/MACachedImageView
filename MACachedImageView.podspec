Pod::Spec.new do |s|
  ...
  s.version      = "1.0.0"
  s.summary      = "Load images from a URL into a local cache before displaying it and display a fancy loading indicator in the meantime."
  ...
  s.platform     = :ios, '6.0'
  s.source_files = 'MACachedImageView/MACachedImageView.{h,m}','NSString+MD5.{h,m}'
